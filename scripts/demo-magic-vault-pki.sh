...
section "1.5 Issue Certificate (Simplified Flow)"
p "Issuing a new certificate using Vault's simplified flow (CN=${CN}, ttl=${TTL_DEMO})"
...
section "1.6 Show Certificate Details"
...
section "1.7 List Existing Certificates"
p "Showing all certificates in the PKI store"
pe  "vault list ${PKI_PATH}/certs"

section "1.8 Verify Certificate Chain"
...
section "1.9 Certificate Renewal"
...
p "   • Traditional CSR-based certificate workflow (step 1.4)"
p "   • Vault's simplified certificate issuance (step 1.5)"  
...
p ""
p "🎯 Key takeaway: Vault PKI offers both traditional CSR signing"
p "   and simplified direct certificate issuance workflows."